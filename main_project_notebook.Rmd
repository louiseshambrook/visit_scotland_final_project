...
demographics %>%
  ...
  labs(x = "Year",
       y = "Total visits (million)",
       title = "Total visits by demographic 2013-2019",
       fill = "Access to car") +
  scale_fill_manual(values = c("Access to car (1+)" = "#6B085E",
                               "No access to car (0)" = "#6B084E"))
```
...
accomodation %>%
  ...
  scale_fill_manual(values = c("Caravan & Camping Parks" = "#6B085E",
                               "Guest House/B&B" = "#af004e",
                               "Hostels" = "#6B085E",
                               "Hotels" = "#6B085E",
                               "Self Catering" = "#6B085E"))
