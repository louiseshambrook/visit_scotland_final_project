...
This is what needs sanity checking
```{r}
...
I will repeat this process with vists - which should be a lot more straight forward, given that I have already done it with spend
```{r}
